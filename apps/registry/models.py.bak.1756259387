...
class Provider(models.Model):
    ...
    npi = models.CharField(max_length=15, blank=True, default="")
...
class Coverage(models.Model):
    ...
    coinsurance_percent = models.DecimalField(max_digits=5, decimal_places=2, default=0, help_text="Percent 0-100")
    deductible = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    oop_max = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    ...
    class Meta:
        indexes = [models.Index(fields=["member_id","group_number"]), models.Index(fields=["patient","is_primary","priority"])]
